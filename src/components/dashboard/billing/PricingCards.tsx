...
const PLANS = [
  {
    ...
    features: [
      ...
      '10 Job Radar alerts/month',
      '5 DOCX rewrites/month',
      'Application tracker',
  ...
  },
  {
    ...
    popular: true,
    features: [
      '40 resume engine runs/month',
      '40 cover letters/month',
      '60 interview sessions/month',
      '15 salary insights/month',
      '30 LinkedIn optimizations/month',
      '30 skill gap analyses/month',
      '30 Job Radar alerts/month',
      '20 DOCX rewrites/month',
      'Application tracker',
